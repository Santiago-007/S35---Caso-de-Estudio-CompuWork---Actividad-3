...
public class ActualizarDepa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Actualizar departamento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarDepa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizarDepa().setVisible(true);
            }
        });
    }
